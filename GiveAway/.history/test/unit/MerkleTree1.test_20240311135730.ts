  ...
  describe("Deployment", function () {
    ...
    const fixture = async () => {
      ...
      const values = [
        ...
        [
          keccak256(ethers.utils.defaultAbiCoder.encode(["address", "address", "address"], [wallets[3].address, wallets[4].address, wallets[5].address])),
          "2",
          "22222"
        ],
        [
          keccak256(ethers.utils.defaultAbiCoder.encode(["address", "address", "address"], [wallets[6].address, wallets[7].address, wallets[8].address])),
          "3",
          "33333"
        ]
      ];
