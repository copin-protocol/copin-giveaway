...
import { ethers, waffle , import { createFixtureLoader } from "@nomiclabs/hardhat-ethers/dist/src/utils"; } from "hardhat";
...
describe("Reward contract", function () {
  describe("Deployment", function () {
    ...
    beforeEach("load fixture", async () => {
      ({ unitReward, rewardContract, rewardTokenContract, total } =
