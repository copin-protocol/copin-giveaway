...
import { utils as ethersUtils } from "ethers/utils";
describe("Reward contract", function () {
  describe("Deployment", function () {
    ...
    const fixture = async () => {
      ...
      const values = [
        [
          keccak256( abi.encode(["address", "address", "address"], [wallets[0].address, wallets[1].address, wallets[2].address])),
          "1",
          "11111"
        ],
        [
          keccak256( abi.encode(["address", "address", "address"], [wallets[3].address, wallets[4].address, wallets[5].address])),
          "2",
          "22222"
        ],
        [
          keccak256( abi.encode(["address", "address", "address"], [wallets[6].address, wallets[7].address, wallets[8].address])),
          "3",
          "33333"
        ]
      ];
