...
import { encodeBase58, encodeBytes32String } from "ethers";
describe("Reward contract", function () {
  describe("Deployment", function () {
    ...
    const fixture = async () => {
      ...
      const values = [
        [
          keccak256( encodeBase58(["address", "address", "address"], [wallets[0].address, wallets[1].address, wallets[2].address])),
          "1",
          "11111"
        ],
        [
