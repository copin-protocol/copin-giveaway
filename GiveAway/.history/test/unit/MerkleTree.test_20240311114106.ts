...
describe("Reward contract", function () {
  describe("Deployment", function () {
    ...
    it("Should initialize contract with correct initial values", async function () {
      const { merkletreeContract, rewardCoinAddress, tree } =
    ...
    it("Should address 1 claimReward ", async function () {
      ...
      const proof = [
        ethers.utils.hexZeroPad("0xbfdc70f4af1219d21cbf011973621eb006c2e83a711a0688f4521b49931a8b56", 32),
        ethers.utils.hexZeroPad("0x7ca6faf4b88bcbb77fcba940a8967af35fe4d4d316b8bd35dd233fc12bdb8a7a", 32),
        ethers.utils.hexZeroPad("0x06847bad5c5113e6739462332ba8640c2d04952cb924c71146eff9b955dbf46a", 32)
    ];
