...
describe("Reward contract", function () {
  ...
  it("Should ", async function () {
    ...
    const CC1 = await rewardContract.getEligibleCriteriaCount(addr1.ad);
    const CC2 = await rewardContract.getEligibleCriteriaCount(addr2);
    console.log("Count Criterial Addr1 :", CC1);
    console.log("Count Criterial Addr2 :", await rewardContract.getEligibleCriteriaCount(addr2));
    // Assert that the final balances are correct
    expect(finalBalanceRewardContract).to.equal(total);
  });
