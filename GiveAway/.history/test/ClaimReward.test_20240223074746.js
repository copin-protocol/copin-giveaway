...
describe("Reward contract", function () {
  ...
  it("Should add 200 addresses to a criterial use addCriterial", async function () {
    ...
    console.log("Gas used for adding 200 addresses 2 %s ~ 0.04$:", gasUsed); 
  ...
  it("Should allow eligible user to claim reward", async function () {
    ...
    // Verify the balance of the reward contract
    const finalBalanceRewardContract = await rewardTokenContract.balanceOf(addrRewardContract);
    console.log("Balance: ", finalBalanceRewardContract.toString());
