...
describe("Reward contract", function () {
  ...
  it("Should ", async function () {
    ...
    console.log("Count Criterial Addr1 :", await rewardContract.getEligibleCriteriaCount());
    console.log("Count Criterial Addr2 :", await rewardContract.getEligibleCriteriaCount());
    // Assert that the final balances are correct
    expect(finalBalanceRewardContract).to.equal(total);
  });
