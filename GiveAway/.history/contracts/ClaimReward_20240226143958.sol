...
contract GiveAway is ReentrancyGuard {
    ...
    event AddressEligibilityUpdated(address indexed updatedAddress, uint256 criterialId, bool isEligible);
    ...
    function updateAddressEligibility(address _address, uint256 criterialId, bool isEligible) public onlyOwner {
        require(criterials[criterialId].eligibleAddresses[_address], "Address is not eligible for this criterial");
        userEligibleForCriterial[_address][criterialId] = isEligible;
        emit AddressEligibilityUpdated(_address, criterialId, isEligible);
    }
