...
contract Reward {
    ...
    function getCriterial(uint256 criterialId)
        public
        view
        returns (
            bytes32,
    ...
    {
        Criterial storage criterial = criterials[criterialId];
        console.log("Crierial Label :",criterial.label ,)
        return (criterial.label, criterial.eligibleAddresses, criterial.unitReward);
    }
}
