...
/// @author TanDlab2k2 
/// @dev This contract help get random words from ChainLinkVRF
contract GiveAway is ReentrancyGuard {
    ...
    uint8 private CurrentCriterialId;
    ...
    function addCriterial(
        ...
        Criterial storage criterial = criterials[CurrentCriterialId];
    ...
    function getEligibleCriteriaCount(address _walletAddress) external view returns (uint256) {
        ...
        for (uint256 i = 1; i < CurrentCriterialId; ) {
